        ...
        <motion.div initial="initial" animate="animate" variants={{ animate: { transition: { staggerChildren: 0.1 } } }}>
          <motion.div variants={fadeInUp} className="mb-8">
            <div className="text-center">
              <h1 className="text-4xl font-bold text-primary mb-4">بنك الأسئلة</h1>
              <p className="text-xl text-muted-foreground mb-8">استعرض وتدرب على آلاف الأسئلة في جميع المواد</p>
            </div>
          </motion.div>
