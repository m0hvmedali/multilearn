...
export default function SettingsPage() {
  ...
  useEffect(() => {
    const anim = typeof window !== "undefined" ? localStorage.getItem("enable_animations") : null
    const three = typeof window !== "undefined" ? localStorage.getItem("enable_3d") : null
    setSettings((prev: any) => ({
      ...prev,
      preferences: {
        ...prev.preferences,
        animations: anim !== "false",
        background3d: three !== "false",
      },
    }))
  }, [])
  ...
  const handleSettingChange = (category: string, key: string, value: any) => {
    ...
    if (category === "preferences") {
      if (key === "animations") {
        localStorage.setItem("enable_animations", value ? "true" : "false")
      }
      if (key === "background3d") {
        localStorage.setItem("enable_3d", value ? "true" : "false")
      }
    }
  }
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        <Label htmlFor="background3d">تفعيل الخلفية ثلاثية الأبعاد</Label>
                        <input
                          type="checkbox"
                          id="background3d"
                          checked={(settings as any).preferences.background3d}
                          onChange={(e) => handleSettingChange("preferences", "background3d", e.target.checked)}
                          className="h-4 w-4 text-emerald-600 focus:ring-emerald-500 border-gray-300 rounded"
                        />
                      </div>
                      <div className="flex items-center justify-between">
